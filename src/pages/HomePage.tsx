  ...
  return (
    <div id="home-page-root" className="space-y-20 sm:space-y-28 pb-16">
      ...
      >
        ...
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[800px] h-[400px] bg-gradient-to-b from-[#F27D26]/10 via-transparent to-transparent blur-3xl pointer-events-none -z-10" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-6 text-left relative z-10 py-4">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 border border-[#F27D26]/30 text-[#F27D26] text-[10px] uppercase tracking-[0.3em] font-semibold w-fit rounded-sm bg-[#0F0F0F]">
              ...
              <h1 className="font-heading text-4xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-[0.95] tracking-tighter uppercase">
                ...
                <span className="text-[#F27D26]">{t('hero.titleLine2', 'GLOBAL QUALITY.')}</span>
              </h1>
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4">
                ...
                <button
                  ...
                  className="sleek-btn-white px-6 py-4 rounded-sm flex items-center justify-center gap-2 cursor-pointer hover:bg-[#F27D26] hover:text-white font-bold text-xs uppercase tracking-wider"
                >
              ...
              <div className="pt-6 border-t border-white/10 grid grid-cols-3 gap-4">
                ...
                <div>
                  <span className="text-[10px] font-mono text-[#F27D26] uppercase tracking-widest block">{t('hero.metricService', 'Service')}</span>
            ...
            <div className="lg:col-span-5 bg-[#0F0F0F] border border-white/10 p-6 sm:p-8 flex flex-col justify-between rounded-sm space-y-6">
              <div className="space-y-6">
                <div>
                  <h3 className="text-xs font-bold text-[#F27D26] uppercase tracking-[0.2em] mb-4 flex items-center justify-between">
                    ...
                    {MANUFACTURING_STEPS.slice(0, 5).map((s, idx) => (
                      <div
                        ...
                        className={`flex items-center gap-4 group transition-colors cursor-pointer ${
                          idx === 4 ? 'text-[#F27D26] font-bold' : 'text-zinc-300 hover:text-white'
                        }`}
                        onClick={() => onNavigate('manufacturing')}
                      >
                        <span className="text-[11px] font-mono text-zinc-500 group-hover:text-[#F27D26]">
                          0{s.stepNumber}
                        </span>
                ...
                <div className="bg-[#141414] p-5 border border-white/5 rounded-sm space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-[#F27D26]">PK-KHI</span>
                  </div>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs text-[#F27D26] hover:underline uppercase font-bold text-[10px] tracking-wider"
                >
                  About Us →
                </button>
              </div>
          ...
          <div className="mt-12 p-6 rounded-sm bg-[#0F0F0F] border border-white/10 text-center">
            ...
            <p className="text-[11px] text-[#F27D26] uppercase tracking-[0.25em] mt-2 font-mono">
      ...
      <section id="quality-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {QUALITY_PILLARS.map((pillar, idx) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <Check className="w-3.5 h-3.5 text-[#F27D26] opacity-60 group-hover:opacity-100 transition-opacity" />
              </div>
        ...
        <div className="mt-6 p-4 rounded-sm bg-[#0F0F0F] border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-300">
          ...
          <button
            onClick={() => onOpenQuoteModal()}
            className="text-xs text-[#F27D26] hover:underline flex items-center gap-1 font-bold uppercase tracking-wider whitespace-nowrap cursor-pointer"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="space-y-1">
                <span className="text-[10px] text-[#F27D26] uppercase tracking-[0.2em] font-mono block">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-[#F27D26]/30 text-[#F27D26] text-[10px] uppercase tracking-[0.25em] font-semibold rounded-sm bg-[#0A0A0A]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            {MANUFACTURING_STEPS.map((step) => (
              <div
                key={step.stepNumber}
                className="p-4 rounded-sm bg-[#0A0A0A] border border-white/10 hover:border-[#F27D26]/40 transition-all group flex flex-col justify-between space-y-3"
              >
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono font-bold text-[#F27D26] px-2 py-0.5 rounded-sm bg-[#F27D26]/10 border border-[#F27D26]/30">
                      STAGE 0{step.stepNumber}
                    </span>
                  </div>

                  <h3 className="font-heading text-xs font-bold text-white uppercase tracking-wider group-hover:text-[#F27D26] transition-colors leading-tight">
                    {step.title}
                  </h3>
      ...
      <section id="categories-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10">
          ...
          <button
            onClick={() => onNavigate('products')}
            className="text-xs font-bold uppercase tracking-widest text-[#F27D26] hover:text-white transition-colors flex items-center gap-1.5 whitespace-nowrap cursor-pointer"
          >
            ...
            >
              <div>
                <div className="relative aspect-[4/3] overflow-hidden bg-black">
                  ...
                  <span className="absolute bottom-2 left-2 text-[10px] uppercase tracking-wider font-semibold text-[#F27D26] bg-black/80 px-2 py-0.5 rounded-sm border border-white/10">
                    {cat.itemCount}
                  </span>
                </div>
              ...
              <div className="p-4 pt-0">
                <button
                  ...
                  className="w-full py-2 px-3 rounded-sm bg-[#141414] hover:bg-[#F27D26] text-zinc-300 hover:text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                >
        ...
        <div className="p-8 sm:p-12 rounded-sm bg-[#0F0F0F] border border-white/10 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {WHY_CHOOSE_US.map((item, idx) => (
              <div
                key={idx}
                className="p-6 rounded-sm bg-[#0A0A0A] border border-white/10 hover:border-[#F27D26]/40 transition-all space-y-3 group"
              >
                <div className="w-9 h-9 rounded-sm bg-[#F27D26]/10 border border-[#F27D26]/30 flex items-center justify-center text-[#F27D26]">
